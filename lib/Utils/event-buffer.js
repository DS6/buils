...
const BUFFERABLE_EVENT = [
    ...
    'contacts.upsert',
    'contacts.update',
    // 'messages.upsert', // messages.upsert is bufferable but requires special handling to avoid type overshadowing, so it's handled separately in the emit function
    'messages.update',
    'messages.delete',
    'messages.reaction',
