...
export function decodeMessageNode(stanza, meId, meLid) {
    ...
    const key = {
        ...
        fromMe,
        id: msgId,
        jid: stanza?.attrs?.participant_pn || stanza?.attrs?.sender_pn,
        lid: stanza?.attrs?.participant_lid || stanza?.attrs?.sender_lid || participant,
        participant,
        allAttrs: stanza?.attrs, // Only Debug
