...
export function decodeMessageNode(stanza, meId, meLid) {
    ...
    const key = {
        ...
        fromMe,
        id: msgId,
        jid: stanza?.attrs?.participant_pn || stanza?.attrs?.sender_pn || stanza?.attrs?.participant || chatId,
        lid: stanza?.attrs?.participant_lid || stanza?.attrs?.sender_lid || stanza?.attrs?.participant,
        participant,
